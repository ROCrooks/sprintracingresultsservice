...
$listregattassql = "SELECT DISTINCT g.`Key`, g.`Name`, g.`Date`, g.`Days` FROM `regattas` g";
...
$allregattalist = dbprepareandexecute($srrsdblink,$listregattassql,$regattaconstraints);
foreach($allregattalist as $allregattalistkey=>$regattadetailsline)
  {
  include 'process-regatta-details.php';
  $allregattalist[$allregattalistkey] = $regattadetailsline;
  }
?>
